export default function TermsPage() {
    return (
      <main style={{ padding: "40px", maxWidth: "800px", margin: "0 auto", lineHeight: "1.8" }}>
        ...
        <h2>第2条（サービス内容） / Article 2 (Service Description)</h2>
        <p>
        ...
        <h2>第4条（禁止事項） / Article 4 (Prohibited Activities)</h2>
        <ul>
          <li>法令または公序良俗に違反する行為 / Violating laws or public order</li>
          <li>本アプリの運営を妨害する行為 / Interfering with the App</li>
          <li>不正アクセスまたはその試み / Unauthorized access</li>
          <li>その他不適切と判断される行為 / Other inappropriate actions</li>
        </ul>
  
        <h2>第5条（免責事項） / Article 5 (Disclaimer)</h2>
        <p>
        ...
        <h2>第6条（変更・停止） / Article 6 (Changes & Suspension)</h2>
        <p>
        ...
        <h2>第7条（規約変更） / Article 7 (Modification)</h2>
        <p>
        ...
        <h2>第8条（準拠法・管轄） / Article 8 (Governing Law)</h2>
        <p>
        ...
        <h2>第9条（未成年） / Article 9 (Minors)</h2>
        <p>
        ...
        <h2>第10条（お問い合わせ） / Article 10 (Contact)</h2>
        <p>
          お問い合わせ：ebidevlab.app@gmail.com
        </p>
        <p>
